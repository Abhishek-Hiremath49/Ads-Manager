...
def publish_scheduled_posts():
    ...
    from ads_manager.ads_manager.ads_manager.services.ad_post_service import PostService

    posts = frappe.get_all(
        "Ad Campaign", filters={"status": "Scheduled", "scheduled_time": ["<=", now_datetime()]}, pluck="name"
    )
...
def refresh_expiring_tokens():
    ...
    from ads_manager.ads_manager.ads_manager.services.ad_token_service import TokenService
...
def fetch_daily_analytics():
    ...
    from ads_manager.ads_manager.services.ad_analytics_service import AnalyticsService
